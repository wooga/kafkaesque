...
Gem::Specification.new do |s|
  ...
  s.authors = ["Stefan Mees", "Tim Lossen"]
  s.date = "2012-06-14"
  s.description = "helper lib to create jruby kafka consumers"
  s.email = "stefan.mees@wooga.com"
  s.extra_rdoc_files = [
    "LICENSE",
    "README.md"
  ]
  ...
  s.homepage = "http://github.com/wooga/kafkaesque"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.15"
  s.summary = "helper lib to create jruby kafka consumers"
